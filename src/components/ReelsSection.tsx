...
const reels = [
  ...
  { id: 2, title: 'Fashion design', category: 'Saree Fashion', views: '', likes: '', color: 'from-pink-600 to-rose-800', emoji: '👗', videoUrl: 'https://mtsvqzvisqfzlvbixepa.supabase.co/storage/v1/object/public/reels-videos/niki.mp4', href: 'https://www.instagram.com/reel/DYE_owTxLQy/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==' },
  ...
  { id: 4, title: 'FreeLancer', category: 'website Designer', views: '', likes: '', color: 'from-amber-600 to-orange-800', emoji: '✈️', videoUrl: 'https://mtsvqzvisqfzlvbixepa.supabase.co/storage/v1/object/public/reels-videos/webinor.mp4', href: 'https://www.instagram.com/reel/DYFA97ARrMU/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA==' },
